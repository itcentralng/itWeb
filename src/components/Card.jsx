...
function Card(props) {
    ...
    return (
            <div className='card' style={{height: props.height, width: props.width, border: props.border}} onMouseOver={() =>{setIsHovered(true);}} onMouseOut = {() =>{setIsHovered(false)}}>
                <img src={isHovered ? props.trueImage : props.falseImage } height = '50rem' width ={props.imageWidth} alt="" style={{backgroundColor: isHovered? 'rgb(0,112,192)' :'rgb(0,112,192, 0.05)'}} />
