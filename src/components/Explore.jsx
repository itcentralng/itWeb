...
function Explore() {
  ...
  // }
    ...
    const ExploreData = Data.map(function(eachData){
        return <Card key = {eachData.title} title = {eachData.title} info = {eachData.info} trueImage = '/Images/White-bulb.svg' falseImage = '/Images/Blue-bulb.svg' height = '25vh' width = '20%' imageWidth = '50vw'/>
    })
  return (
    <div id='Explore'>
